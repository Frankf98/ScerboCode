  ...
  var I = (function () {
      ...
      return (
        ...
        (t.plus = function (t) {
          ...
          for (
            var e = y.fromDurationLike(t), n = {}, r = 0, i = E;
            r < i.length;
            r++
          ) {
            var o = i[r];
        ...
        (t.minus = function (t) {
          return this.isValid
            ? ((t = y.fromDurationLike(t)), this.plus(t.negate()))
            : this;
        }),
      ...
      return (
        ...
        (t.toLocaleString = function (t, e) {
          return (
            ...
            void 0 === e && (e = {}),
            this.isValid
              ? S.create(this.s.loc.clone(e), t).formatInterval(this)
              : rn
          );
        }),
        (t.toISO = function (t) {
  ...
  function sn(t, e, n, r) {
    var t = (function (t, e, n) {
      ...
      e =
        ...
        I.fromObject(o, r));
    return 0 < n.length
      ? (t = I.fromMillis(u, r)).shiftTo.apply(t, n).plus(e)
      : e;
  }
  var cn = {
      arab: "[٠-٩]",
  ...
  function Hn(t, e, n, r, i, o) {
    ...
    return (t && 0 !== Object.keys(t).length) || e
      ? ((t = L.fromObject(t, s({}, n, { zone: e || u, specificOffset: o }))),
        a ? t : t.setZone(u))
      : L.invalid(
          new O("unparsable", 'the input "' + i + "\" can't be parsed as " + r)
        );
  }
  function Wn(t, e, n) {
    return (
      ...
      r ||
        (o =
          t.old && t.old.ts === this.ts && t.old.zone.equals(n)
            ...
            : ((e = n.offset(this.ts)),
              (i = Un(this.ts, e)),
              (i = (r = Number.isNaN(i.year) ? new O("invalid input") : null)
                ? null
                : i),
              r ? null : e)),
        (this._zone = n),
    ...
    return (
      ...
      (t.setZone = function (t, e) {
        ...
        return (t = w(t, k.defaultZone)).equals(this.zone)
          ...
          ? ((n = this.ts),
            (r || e) &&
              ((r = t.offset(this.ts)), (n = Pn(this.toObject(), r, t)[0])),
            qn(this, { ts: n, zone: t }))
          : p.invalid(An(t));
      }),
      (t.reconfigure = function (t) {
      ...
      (t.minus = function (t) {
        return this.isValid
          ? qn(this, Rn(this, I.fromDurationLike(t).negate()))
          : this;
      }),
      ...
      (t.toFormat = function (t, e) {
        return (
          void 0 === e && (e = {}),
          this.isValid
            ? S.create(this.loc.redefaultToEN(e)).formatDateTimeFromString(
                this,
                t
              )
            : jn
      ...
      (t.toLocaleString = function (t, e) {
        return (
          ...
          void 0 === e && (e = {}),
          this.isValid
            ? S.create(this.loc.clone(e), t).formatDateTime(this)
            : jn
        );
      }),
      (t.toLocaleParts = function (t) {
        return (
          void 0 === t && (t = {}),
          this.isValid
            ? S.create(this.loc.clone(t), t).formatDateTimeParts(this)
            : []
        );
      }),
      (t.toISO = function (t) {
      ...
      (t.toISODate = function (t) {
        t = (void 0 === t ? {} : t).format;
        return this.isValid
          ? Jn(this, "extended" === (void 0 === t ? "extended" : t))
          : null;
      }),
      ...
      o(
        ...
        [
          ...
          },
          {
            ...
            get: function () {
              return this.isValid
                ? an.months("short", { locObj: this.loc })[this.month - 1]
                : null;
            },
          },
          {
            ...
            get: function () {
              return this.isValid
                ? an.months("long", { locObj: this.loc })[this.month - 1]
                : null;
            },
          },
          {
